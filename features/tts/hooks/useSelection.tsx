      ...
      if (
        ...
        while (currentNode) {
          if (
            ...
            const replaceElement = replaceElements.find((item) =>
              item.contains(currentNode?.parentElement as HTMLElement),
            );
            if (replaceElement) {
              const usedHtmlElement =
                replaceElement.querySelector<HTMLElement>(':scope > span:last-child') || undefined;
